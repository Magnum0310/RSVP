...
const UserForm = ({ statePanel, setPanel, stateForm, setForm }) => {
  ...
  return (
    <div className="relative flex h-full w-full flex-col justify-center gap-5 bg-red-400">
      <div>
        {/* Buttons */}
        ...
        <div className="flex size-full">
          <div
            className={`flex ${invite === 2 ? "basis-1/2" : invite === 1 ? "basis-3/4" : "basis-1/4"} relative flex-col gap-2 bg-emerald-500`}
          >
            {/* Accept invitation */}
            <form
